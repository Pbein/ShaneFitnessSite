...
export const aboutPage: AboutPage = {
  ...
  // Shane's authentic words (his original Squarespace "About Me"). Do not AI-reword.
  story: [
  ...
  // Shane's authentic words (his original Squarespace "My Goal for you"). Do not AI-reword.
  goal: [
    "Both my journey and relationship with all things health and exercise, have been anything but linear.",
    "My initial interest in health and wellness began more than 15 years ago. Since then, I have explored many concepts, trends, routines, diets, supplements, and so on. All for better or for worse, took me down a unique path of learning and understanding.",
    "However after years of working towards my own fitness goals, and working with others to achieve their own, I gathered the following:",
    ...
    "My goal is to provide you with a foundation to begin or enhance an exercise routine specific to you, that is simple and sustainable, and above all, that you ENJOY!",
