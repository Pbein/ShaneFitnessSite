...
export const aboutPage: AboutPage = {
  ...
  story: [
    "I'm a NASM Certified Personal Trainer with a Master of Science in Health Promotion Management from American University. My background combines evidence-based health education, behavior-change research, and hands-on coaching with a wide range of people — beginners, busy professionals, recreational athletes, and anyone looking to improve their overall health and quality of life.",
    "My passion for health and wellness began more than a decade ago through my own fitness journey. Over the years I've spent countless hours learning — through both formal education and personal trial and error — exploring different training methods, nutrition strategies, recovery techniques, and approaches to long-term health. That experience taught me that sustainable results rarely come from extremes. They come from building simple habits and systems that fit into everyday life.",
    "Through my graduate studies I developed a strong interest in health behavior change and the psychology behind lasting transformation. My research focused on how people build healthy habits, overcome barriers, and create meaningful change that lasts. That perspective continues to shape my coaching today.",
    "I also have a particular interest in chronic pain, movement, and the relationship between physical and mental well-being. Stress, pain, previous injuries, confidence, and daily demands all play a role in long-term success, and I help clients navigate those challenges with a realistic, sustainable approach.",
    "Outside of coaching, my interests include Brazilian Jiu-Jitsu, continually improving my Spanish, and a deep interest in mental health and personal growth. These passions reinforce my belief that health is about far more than appearance — it's about resilience, enjoyment, confidence, capability, and a lifestyle that supports the life you want to live.",
  ],
  goalHeading: "My goal for you",
  goal: [
    "My relationship with health and exercise has been anything but linear. My interest began more than 15 years ago, and since then I've explored countless concepts, trends, routines, diets, and supplements — for better and for worse — each taking me down a unique path of learning.",
    "My goal is to give you a foundation to begin or enhance an exercise routine that's specific to you, simple, sustainable, and above all — that you ENJOY. I want to teach you enough that eventually you don't need me at all.",
  ],
  mission:
    "My mission is simple: help you build sustainable habits, improve your health, and become the strongest version of yourself — physically and mentally.",
};
