# Owner's Guide — Train Shane Website

Welcome! This is your plain-English guide to your website. You don't need to know any code, and you'll never touch GitHub, hosting, or the design. You just manage **what the site says** — the words, prices, photos, and links.

---

## What you can change vs. what stays fixed

| You control ✅ | The developer controls 🔒 |
|---|---|
| Text and headlines | Layout and spacing |
| Prices | Colors, fonts, animations |
| Photos | How sections are arranged |
| Your booking link | The code |
| Your payment links | Hosting and the domain |

This is on purpose: it keeps the site looking polished and consistent no matter what you change.
...
## Need help?
Text or email me anytime. For anything beyond text/price/photo/link — new sections, design tweaks, new pages — that's my job, just let me know what you want.
